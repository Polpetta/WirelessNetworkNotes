...
\mKeyword{overhead}: since overhead has a fixed size, independent from the
...
$500\ data + 40\ overhead$. We still prefer \mKeyword{splitting} because, when
facing a big error rate, we don't want to lose all the packets.
The WLAN channel access is shared using \mKeyword{random access} and this system
